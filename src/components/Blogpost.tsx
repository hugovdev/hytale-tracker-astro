...
export default function Blogpost(props: any) {
    ...
    return <a href={post ?
        ...
        <div className="flex flex-col md:flex-row rounded-2xl shadow-md hover:shadow-lg dark:hover:shadow-slate-900/80">
            ...
            <div className="bg-slate-100 dark:bg-slate-800 py-5 px-8 md:rounded-tr-2xl rounded-br-2xl rounded-bl-2xl md:rounded-bl-none h-[265px] md:h-auto w-full">
                <div className="max-h-full md:max-h-[130px] overflow-y-hidden">
                    {post ? <div className="font-bold text-base md:text-lg text-slate-900 dark:text-slate-300 leading-5">{post.title}</div> :
                    ...
                    {post ? <div className="pb-5 dark:text-slate-400 text-slate-800 text-sm md:text-base font-medium">{post.bodyExcerpt} </div> :
